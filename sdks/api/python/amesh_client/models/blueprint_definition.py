...
class BlueprintDefinition(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["blueprintId", "documentation", "license", "localOnly", "parameters", "provenance", "source", "summary", "tags", "template", "title", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BlueprintDefinition from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BlueprintDefinition from a dict"""
        if obj is None:
            return None
