...
export function ExecutionDetailPage() {
  ...
  const graph = useQuery({ queryKey: ['execution-graph', executionId, settings.tenant], queryFn: () => api.executionGraph(executionId), enabled: Boolean(executionId), refetchInterval: 5_000 })
