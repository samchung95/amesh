...
public class AgentSessionCheckpoint {
  ...
  public static final String JSON_PROPERTY_LAST_CONTEXT_RECEIPT = "lastContextReceipt";
  private JsonNullable<AgentContextReceipt> lastContextReceipt = JsonNullable.<AgentContextReceipt>undefined();
  ...
  public AgentSessionCheckpoint lastContextReceipt(@javax.annotation.Nullable AgentContextReceipt lastContextReceipt) {
    this.lastContextReceipt = JsonNullable.<AgentContextReceipt>of(lastContextReceipt);
    return this;
  }

  /**
   * Get lastContextReceipt
   * @return lastContextReceipt
   */
  @javax.annotation.Nullable
  @JsonIgnore
  public AgentContextReceipt getLastContextReceipt() {
        return lastContextReceipt.orElse(null);
  }

  @JsonProperty(value = JSON_PROPERTY_LAST_CONTEXT_RECEIPT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<AgentContextReceipt> getLastContextReceipt_JsonNullable() {
    return lastContextReceipt;
  }

  @JsonProperty(JSON_PROPERTY_LAST_CONTEXT_RECEIPT)
  public void setLastContextReceipt_JsonNullable(JsonNullable<AgentContextReceipt> lastContextReceipt) {
    this.lastContextReceipt = lastContextReceipt;
  }

  public void setLastContextReceipt(@javax.annotation.Nullable AgentContextReceipt lastContextReceipt) {
    this.lastContextReceipt = JsonNullable.<AgentContextReceipt>of(lastContextReceipt);
  }
  ...
  @javax.annotation.Nullable
  @JsonIgnore
  public ToolPlanLedger getToolPlan() {
        return toolPlan.orElse(null);
  }

  @JsonProperty(value = JSON_PROPERTY_TOOL_PLAN, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<ToolPlanLedger> getToolPlan_JsonNullable() {
    return toolPlan;
  }

  @JsonProperty(JSON_PROPERTY_TOOL_PLAN)
  public void setToolPlan_JsonNullable(JsonNullable<ToolPlanLedger> toolPlan) {
    this.toolPlan = toolPlan;
  }

  public void setToolPlan(@javax.annotation.Nullable ToolPlanLedger toolPlan) {
    this.toolPlan = JsonNullable.<ToolPlanLedger>of(toolPlan);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `lastContextReceipt` to the URL query string
    if (getLastContextReceipt() != null) {
      joiner.add(getLastContextReceipt().toUrlQueryString(prefix + "lastContextReceipt" + suffix));
    }
    ...
    if (getToolPlan() != null) {
      joiner.add(getToolPlan().toUrlQueryString(prefix + "toolPlan" + suffix));
    }
