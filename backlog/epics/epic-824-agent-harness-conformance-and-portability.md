...
- [x] Pi runs the complete kit in CI and produces a machine-readable compatibility report tied to exact adapter and package versions.
...
- CI deterministic-report and production-image probes.
