...
import io.amesh.client.model.ExecutionEventType;
 ...
 */
@JsonPropertyOrder({
  ExecutionEvent.JSON_PROPERTY_ACTOR_ID,
  ExecutionEvent.JSON_PROPERTY_CAUSATION_ID,
  ExecutionEvent.JSON_PROPERTY_CORRELATION_ID,
  ExecutionEvent.JSON_PROPERTY_EVENT_ID,
  ExecutionEvent.JSON_PROPERTY_EVENT_TYPE,
  ExecutionEvent.JSON_PROPERTY_IDEMPOTENCY_KEY,
...
public class ExecutionEvent {
  ...
  public ExecutionEvent actorId(@javax.annotation.Nullable String actorId) {
  ...
  public ExecutionEvent causationId(@javax.annotation.Nullable UUID causationId) {
  ...
  public ExecutionEvent correlationId(@javax.annotation.Nullable UUID correlationId) {
  ...
  public ExecutionEvent eventId(@javax.annotation.Nullable UUID eventId) {
  ...
  public ExecutionEvent eventType(@javax.annotation.Nonnull ExecutionEventType eventType) {
  ...
  @JsonProperty(value = JSON_PROPERTY_EVENT_TYPE, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setEventType(@javax.annotation.Nonnull ExecutionEventType eventType) {
    this.eventType = eventType;
  }


  public ExecutionEvent idempotencyKey(@javax.annotation.Nullable String idempotencyKey) {
  ...
  public ExecutionEvent occurredAt(@javax.annotation.Nullable OffsetDateTime occurredAt) {
  ...
  public ExecutionEvent payload(@javax.annotation.Nullable Map<String, Object> payload) {
    this.payload = payload;
    return this;
  }

  public ExecutionEvent putPayloadItem(String key, Object payloadItem) {
  ...
  public ExecutionEvent reason(@javax.annotation.Nullable String reason) {
  ...
  public ExecutionEvent schemaVersion(@javax.annotation.Nullable SchemaVersionEnum schemaVersion) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actorId, executionEvent.actorId) &&
        equalsNullable(this.causationId, executionEvent.causationId) &&
        Objects.equals(this.correlationId, executionEvent.correlationId) &&
        Objects.equals(this.eventId, executionEvent.eventId) &&
        Objects.equals(this.eventType, executionEvent.eventType) &&
        equalsNullable(this.idempotencyKey, executionEvent.idempotencyKey) &&
