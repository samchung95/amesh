...
class CapabilityAttachment(BaseModel):
    ...
    reference: Optional[CapabilityReference] = None
    target: CapabilityAttachmentTarget
    __properties: ClassVar[List[str]] = ["constraints", "reference", "target"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CapabilityAttachment from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CapabilityAttachment from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "reference": CapabilityReference.from_dict(obj["reference"]) if obj.get("reference") is not None else None,
