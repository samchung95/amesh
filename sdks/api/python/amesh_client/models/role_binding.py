...
class RoleBinding(BaseModel):
    ...
    role_name: Annotated[str, Field(min_length=1, strict=True, max_length=128)]
    scope_type: AuthorizationScopeType
    tenant_id: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=63)]] = None
    __properties: ClassVar[List[str]] = ["id", "namespace", "principal_id", "principal_type", "role_name", "scope_type", "tenant_id"]

    @field_validator('role_name', mode="before")
    def role_name_validate_regular_expression(cls, value):
