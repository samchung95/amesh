...
class SearchDocument(BaseModel):
    ...
    relevance: Union[Annotated[float, Field(strict=True, ge=0.0)], Annotated[int, Field(strict=True, ge=0)]]
    source_version: Annotated[int, Field(strict=True, ge=0)] = Field(alias="sourceVersion")
    state: Optional[StrictStr] = None
    summary: StrictStr
    title: StrictStr
    updated_at: datetime = Field(alias="updatedAt")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["documentId", "documentType", "fields", "labels", "namespace", "occurredAt", "relevance", "sourceVersion", "state", "summary", "title", "updatedAt"]
