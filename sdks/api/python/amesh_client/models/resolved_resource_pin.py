...
class ResolvedResourcePin(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["digest", "key", "kind", "resourceId", "revision"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResolvedResourcePin from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResolvedResourcePin from a dict"""
        if obj is None:
            return None
