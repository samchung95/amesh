...
class WebhookDeliveryHistory(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["attempts", "delivery"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebhookDeliveryHistory from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebhookDeliveryHistory from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "attempts": [WebhookDeliveryAttempt.from_dict(_item) for _item in obj["attempts"]] if obj.get("attempts") is not None else None,
