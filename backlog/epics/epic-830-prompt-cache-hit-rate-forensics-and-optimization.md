...
- Release evidence: [`TESTLOG.md`](../../TESTLOG.md) records the historical denominators, provider-free v1/v2 comparison, focused regressions, strict docs suite and complete Docker-local aggregate.
