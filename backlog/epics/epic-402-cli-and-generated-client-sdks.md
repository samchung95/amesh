...
- 2026-08-21 — W6 verified CLI commands for flow validation/apply/list, execution create/get/list/logs and webhook invocation against the MVP REST contract. Evidence: [`TESTLOG.md`](../../docs/reviews/TESTLOG.md), [`test_cli.py`](../../tests/entrypoints/test_cli.py), and [`cli.py`](../../src/amesh/entrypoints/cli.py). Generated SDKs and the broader CLI surface remain open.
...
- tests/entrypoints/test_cli.py and tests/entrypoints/test_cli_contract.py::test_urs_f_0414_0415_0419_0420_profiles_secure_tokens_and_output_modes plus test_urs_f_0414_0416_declarative_stdin_diff_export_delete_and_admin.
- tests/entrypoints/test_cli_contract.py::test_urs_f_0414_0415_0419_0420_profiles_secure_tokens_and_output_modes.
- tests/entrypoints/test_cli_contract.py::test_urs_f_0414_0416_declarative_stdin_diff_export_delete_and_admin.
- tests/sdk/test_sdk_contracts.py::test_urs_f_0417_0418_generated_sdk_manifest_matches_supported_contract and generated Python, TypeScript, Java and Go build checks.
- tests/sdk/test_sdk_contracts.py::test_urs_f_0417_0418_generated_sdk_manifest_matches_supported_contract and test_urs_f_0418_sdk_release_archives_are_reproducible.
- tests/entrypoints/test_cli_contract.py::test_urs_f_0414_0415_0419_0420_profiles_secure_tokens_and_output_modes and deployed AMESH_SERVICE_ACCOUNT_TOKEN CLI smoke.
- tests/entrypoints/test_cli_contract.py::test_urs_f_0421_completion_and_docs_are_generated_from_parser and docs/cli/reference.md freshness check.
