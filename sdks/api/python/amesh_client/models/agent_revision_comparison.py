...
class AgentRevisionComparison(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentRevisionComparison from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentRevisionComparison from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "sameInputSchema": obj.get("sameInputSchema"),
            "sameOutputSchema": obj.get("sameOutputSchema"),
