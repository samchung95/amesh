...
class AgentInvocationRecordOutput(BaseModel):
    """
    AgentInvocationRecordOutput
    """ # noqa: E501
    accounting: Optional[AgentInvocationAccountingOutput] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentInvocationRecordOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentInvocationRecordOutput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "accounting": AgentInvocationAccountingOutput.from_dict(obj["accounting"]) if obj.get("accounting") is not None else None,
