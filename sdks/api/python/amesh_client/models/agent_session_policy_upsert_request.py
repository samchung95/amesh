...
class AgentSessionPolicyUpsertRequest(BaseModel):
    """
    Flattened policy document plus its tenant/namespace/application identity.
    """ # noqa: E501
    admission_enabled: Optional[StrictBool] = Field(default=True, alias="admissionEnabled")
    allowed_harness_ids: Optional[Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=128)]], Field(max_length=100)]] = Field(default=None, alias="allowedHarnessIds")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentSessionPolicyUpsertRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentSessionPolicyUpsertRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "admissionEnabled": obj.get("admissionEnabled") if obj.get("admissionEnabled") is not None else True,
            "allowedHarnessIds": obj.get("allowedHarnessIds"),
