...
class AgentSessionRecord(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["attempt", "capabilityPinId", "checkpoint", "completedAt", "counters", "createdAt", "envelopeDigest", "error", "executionId", "finalResult", "namespace", "phase", "sessionId", "state", "taskRunId", "tenantId", "updatedAt", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentSessionRecord from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentSessionRecord from a dict"""
        if obj is None:
            return None
