...
import io.amesh.client.model.Costusd;
 ...
 */
@JsonPropertyOrder({
  AgentSessionCountersInput.JSON_PROPERTY_BILLING_CERTAINTY,
  AgentSessionCountersInput.JSON_PROPERTY_CACHE_READ_TOKENS,
  AgentSessionCountersInput.JSON_PROPERTY_CACHE_WRITE_TOKENS,
  AgentSessionCountersInput.JSON_PROPERTY_COST_USD,
  AgentSessionCountersInput.JSON_PROPERTY_INPUT_TOKENS,
  AgentSessionCountersInput.JSON_PROPERTY_LOOP_ITERATIONS,
  AgentSessionCountersInput.JSON_PROPERTY_OUTPUT_TOKENS,
  AgentSessionCountersInput.JSON_PROPERTY_PRICED_MODEL_INVOCATIONS,
  AgentSessionCountersInput.JSON_PROPERTY_REASONING_TOKENS,
  AgentSessionCountersInput.JSON_PROPERTY_REPAIR_ATTEMPTS,
  AgentSessionCountersInput.JSON_PROPERTY_TOOL_CALLS,
  AgentSessionCountersInput.JSON_PROPERTY_TOTAL_TOKENS,
  AgentSessionCountersInput.JSON_PROPERTY_TURNS,
  AgentSessionCountersInput.JSON_PROPERTY_UNRESOLVED_MODEL_INVOCATIONS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.24.0")
public class AgentSessionCountersInput {
  ...
  public AgentSessionCountersInput() {
  }

  public AgentSessionCountersInput billingCertainty(@javax.annotation.Nullable AgentBillingCertainty billingCertainty) {
  ...
  public AgentSessionCountersInput cacheReadTokens(@javax.annotation.Nullable Integer cacheReadTokens) {
  ...
  public AgentSessionCountersInput cacheWriteTokens(@javax.annotation.Nullable Integer cacheWriteTokens) {
  ...
  public AgentSessionCountersInput costUsd(@javax.annotation.Nullable Costusd costUsd) {
  ...
  @JsonProperty(value = JSON_PROPERTY_COST_USD, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCostUsd(@javax.annotation.Nullable Costusd costUsd) {
    this.costUsd = costUsd;
  }


  public AgentSessionCountersInput inputTokens(@javax.annotation.Nullable Integer inputTokens) {
  ...
  public AgentSessionCountersInput loopIterations(@javax.annotation.Nullable Integer loopIterations) {
  ...
  public AgentSessionCountersInput outputTokens(@javax.annotation.Nullable Integer outputTokens) {
  ...
  public AgentSessionCountersInput pricedModelInvocations(@javax.annotation.Nullable Integer pricedModelInvocations) {
  ...
  public AgentSessionCountersInput reasoningTokens(@javax.annotation.Nullable Integer reasoningTokens) {
  ...
  public AgentSessionCountersInput repairAttempts(@javax.annotation.Nullable Integer repairAttempts) {
  ...
  public AgentSessionCountersInput toolCalls(@javax.annotation.Nullable Integer toolCalls) {
  ...
  public AgentSessionCountersInput totalTokens(@javax.annotation.Nullable Integer totalTokens) {
  ...
  public AgentSessionCountersInput turns(@javax.annotation.Nullable Integer turns) {
    this.turns = turns;
    return this;
  }
  ...
  public AgentSessionCountersInput unresolvedModelInvocations(@javax.annotation.Nullable Integer unresolvedModelInvocations) {
  ...
  /**
   * Return true if this AgentSessionCounters-Input object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AgentSessionCountersInput agentSessionCountersInput = (AgentSessionCountersInput) o;
    return Objects.equals(this.billingCertainty, agentSessionCountersInput.billingCertainty) &&
        Objects.equals(this.cacheReadTokens, agentSessionCountersInput.cacheReadTokens) &&
        Objects.equals(this.cacheWriteTokens, agentSessionCountersInput.cacheWriteTokens) &&
        Objects.equals(this.costUsd, agentSessionCountersInput.costUsd) &&
        Objects.equals(this.inputTokens, agentSessionCountersInput.inputTokens) &&
        Objects.equals(this.loopIterations, agentSessionCountersInput.loopIterations) &&
        Objects.equals(this.outputTokens, agentSessionCountersInput.outputTokens) &&
        Objects.equals(this.pricedModelInvocations, agentSessionCountersInput.pricedModelInvocations) &&
        Objects.equals(this.reasoningTokens, agentSessionCountersInput.reasoningTokens) &&
        Objects.equals(this.repairAttempts, agentSessionCountersInput.repairAttempts) &&
        Objects.equals(this.toolCalls, agentSessionCountersInput.toolCalls) &&
        Objects.equals(this.totalTokens, agentSessionCountersInput.totalTokens) &&
        Objects.equals(this.turns, agentSessionCountersInput.turns) &&
        Objects.equals(this.unresolvedModelInvocations, agentSessionCountersInput.unresolvedModelInvocations);
  }
  ...
  public String toString() {
    ...
    sb.append("class AgentSessionCountersInput {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getCostUsd() != null) {
      joiner.add(getCostUsd().toUrlQueryString(prefix + "costUsd" + suffix));
    }
