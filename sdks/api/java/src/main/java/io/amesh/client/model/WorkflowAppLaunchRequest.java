 ...
 */
@JsonPropertyOrder({
  WorkflowAppLaunchRequest.JSON_PROPERTY_IDEMPOTENCY_KEY,
  WorkflowAppLaunchRequest.JSON_PROPERTY_INPUTS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.24.0")
public class WorkflowAppLaunchRequest {
  ...
  public WorkflowAppLaunchRequest() {
  }

  public WorkflowAppLaunchRequest idempotencyKey(@javax.annotation.Nullable String idempotencyKey) {
  ...
  public WorkflowAppLaunchRequest inputs(@javax.annotation.Nullable Map<String, Object> inputs) {
    this.inputs = inputs;
    return this;
  }

  public WorkflowAppLaunchRequest putInputsItem(String key, Object inputsItem) {
    if (this.inputs == null) {
  ...
  /**
   * Return true if this WorkflowAppLaunchRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    WorkflowAppLaunchRequest workflowAppLaunchRequest = (WorkflowAppLaunchRequest) o;
    return equalsNullable(this.idempotencyKey, workflowAppLaunchRequest.idempotencyKey) &&
        Objects.equals(this.inputs, workflowAppLaunchRequest.inputs);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(idempotencyKey), inputs);
  }
  ...
  public String toString() {
    ...
    sb.append("class WorkflowAppLaunchRequest {\n");
