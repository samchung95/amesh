...
- Acceptance criterion 15: canonical route, CLI and four generated-client drift evidence is in [`tests/api/test_agent_session_service_contract.py`](../../tests/api/test_agent_session_service_contract.py), [`tests/entrypoints/test_agent_session_cli.py`](../../tests/entrypoints/test_agent_session_cli.py) and [`tests/sdk/test_generated_contracts.py`](../../tests/sdk/test_generated_contracts.py).
