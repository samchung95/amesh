...
function session(overrides: Partial<AgentSessionSummary> = {}): AgentSessionSummary {
  return {
    ...
    contextReceipt: { turn: 2, contextMessageCount: 4, contextBytes: 480, contextEstimatedTokens: 120, compacted: true },
    counters: { turns: 2, loopIterations: 2, toolCalls: 1, totalTokens: 120, costUsd: '0.004', repairAttempts: 1 },
