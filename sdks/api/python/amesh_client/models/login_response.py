...
class LoginResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["absoluteExpiresAt", "display", "idleExpiresAt", "principalId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "absoluteExpiresAt": obj.get("absoluteExpiresAt"),
            "display": obj.get("display"),
            "idleExpiresAt": obj.get("idleExpiresAt"),
