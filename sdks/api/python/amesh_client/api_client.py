...
from amesh_client.configuration import Configuration
from amesh_client.api_response import ApiResponse, T as ApiResponseT
import amesh_client.models
from amesh_client import rest
from amesh_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(amesh_client.models, klass)
