...
func (r ApiPreviewAgentMeshRouteApiV1NamespacesNamespaceAgentMeshRoutesPreviewPostRequest) AgentRouteRequest(agentRouteRequest AgentRouteRequest) ApiPreviewAgentMeshRouteApiV1NamespacesNamespaceAgentMeshRoutesPreviewPostRequest {
	r.agentRouteRequest = &agentRouteRequest
	return r
}

func (r ApiPreviewAgentMeshRouteApiV1NamespacesNamespaceAgentMeshRoutesPreviewPostRequest) Authorization(authorization string) ApiPreviewAgentMeshRouteApiV1NamespacesNamespaceAgentMeshRoutesPreviewPostRequest {
	r.authorization = &authorization
	return r
}

func (r ApiPreviewAgentMeshRouteApiV1NamespacesNamespaceAgentMeshRoutesPreviewPostRequest) XAmeshCSRF(xAmeshCSRF string) ApiPreviewAgentMeshRouteApiV1NamespacesNamespaceAgentMeshRoutesPreviewPostRequest {
	r.xAmeshCSRF = &xAmeshCSRF
	return r
}

func (r ApiPreviewAgentMeshRouteApiV1NamespacesNamespaceAgentMeshRoutesPreviewPostRequest) XAmeshTenant(xAmeshTenant string) ApiPreviewAgentMeshRouteApiV1NamespacesNamespaceAgentMeshRoutesPreviewPostRequest {
	r.xAmeshTenant = &xAmeshTenant
	return r
}

func (r ApiPreviewAgentMeshRouteApiV1NamespacesNamespaceAgentMeshRoutesPreviewPostRequest) Execute() (*AgentRouteDecision, *http.Response, error) {
	return r.ApiService.PreviewAgentMeshRouteApiV1NamespacesNamespaceAgentMeshRoutesPreviewPostExecute(r)
}
...
func (a *AgentsAPIService) PreviewAgentMeshRouteApiV1NamespacesNamespaceAgentMeshRoutesPreviewPostExecute(r ApiPreviewAgentMeshRouteApiV1NamespacesNamespaceAgentMeshRoutesPreviewPostRequest) (*AgentRouteDecision, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/namespaces/{namespace}/agent/mesh/routes/preview"
	localVarPath = strings.Replace(localVarPath, "{"+"namespace"+"}", url.PathEscape(parameterValueToString(r.namespace, "namespace")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.agentRouteRequest == nil {
		return localVarReturnValue, nil, reportError("agentRouteRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.agentRouteRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
