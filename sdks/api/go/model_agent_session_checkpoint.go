...
// GetLastContextReceipt returns the LastContextReceipt field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *AgentSessionCheckpoint) GetLastContextReceipt() AgentContextReceipt {
	if o == nil || IsNil(o.LastContextReceipt.Get()) {
		var ret AgentContextReceipt
		return ret
	}
	return *o.LastContextReceipt.Get()
}

// GetLastContextReceiptOk returns a tuple with the LastContextReceipt field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AgentSessionCheckpoint) GetLastContextReceiptOk() (*AgentContextReceipt, bool) {
	if o == nil {
		return nil, false
	}
	return o.LastContextReceipt.Get(), o.LastContextReceipt.IsSet()
}

// HasLastContextReceipt returns a boolean if a field has been set.
func (o *AgentSessionCheckpoint) HasLastContextReceipt() bool {
	if o != nil && o.LastContextReceipt.IsSet() {
		return true
	}
...
// SetLastContextReceipt gets a reference to the given NullableAgentContextReceipt and assigns it to the LastContextReceipt field.
func (o *AgentSessionCheckpoint) SetLastContextReceipt(v AgentContextReceipt) {
	o.LastContextReceipt.Set(&v)
}

// SetLastContextReceiptNil sets the value for LastContextReceipt to be an explicit nil
func (o *AgentSessionCheckpoint) SetLastContextReceiptNil() {
	o.LastContextReceipt.Set(nil)
}

// UnsetLastContextReceipt ensures that no value is present for LastContextReceipt, not even an explicit nil
func (o *AgentSessionCheckpoint) UnsetLastContextReceipt() {
	o.LastContextReceipt.Unset()
}
...
func (o *AgentSessionCheckpoint) GetToolPlan() ToolPlanLedger {
	if o == nil || IsNil(o.ToolPlan.Get()) {
		var ret ToolPlanLedger
		return ret
	}
	return *o.ToolPlan.Get()
}

// GetToolPlanOk returns a tuple with the ToolPlan field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AgentSessionCheckpoint) GetToolPlanOk() (*ToolPlanLedger, bool) {
	if o == nil {
		return nil, false
	}
	return o.ToolPlan.Get(), o.ToolPlan.IsSet()
}

// HasToolPlan returns a boolean if a field has been set.
func (o *AgentSessionCheckpoint) HasToolPlan() bool {
	if o != nil && o.ToolPlan.IsSet() {
		return true
	}
...
// SetToolPlan gets a reference to the given NullableToolPlanLedger and assigns it to the ToolPlan field.
func (o *AgentSessionCheckpoint) SetToolPlan(v ToolPlanLedger) {
	o.ToolPlan.Set(&v)
}

// SetToolPlanNil sets the value for ToolPlan to be an explicit nil
func (o *AgentSessionCheckpoint) SetToolPlanNil() {
	o.ToolPlan.Set(nil)
}

// UnsetToolPlan ensures that no value is present for ToolPlan, not even an explicit nil
func (o *AgentSessionCheckpoint) UnsetToolPlan() {
	o.ToolPlan.Unset()
}
...
func (o AgentSessionCheckpoint) ToMap() (map[string]interface{}, error) {
	...
	if o.LastContextReceipt.IsSet() {
		toSerialize["lastContextReceipt"] = o.LastContextReceipt.Get()
	}
