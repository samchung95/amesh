...
class SearchRange(BaseModel):
    ...
    SearchRange
    """ # noqa: E501
    var_field: SearchRangeField = Field(alias="field")
    gte: Optional[Gte] = None
    lte: Optional[Lte] = None
    __properties: ClassVar[List[str]] = ["field", "gte", "lte"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "field": obj.get("field"),
            "gte": Gte.from_dict(obj["gte"]) if obj.get("gte") is not None else None,
            "lte": Lte.from_dict(obj["lte"]) if obj.get("lte") is not None else None
        })
        return _obj
