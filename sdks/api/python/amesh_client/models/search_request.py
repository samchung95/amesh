...
class SearchRequest(BaseModel):
    ...
    direction: Optional[SearchSortDirection] = None
    ...
    query: Optional[Annotated[str, Field(strict=True, max_length=500)]] = ''
    ranges: Optional[Annotated[List[SearchRange], Field(max_length=3)]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ranges": [SearchRange.from_dict(_item) for _item in obj["ranges"]] if obj.get("ranges") is not None else None,
            "sort": obj.get("sort"),
