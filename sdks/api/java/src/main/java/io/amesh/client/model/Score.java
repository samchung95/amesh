...
public class Score extends AbstractOpenApiSchema {
    ...
    public static class ScoreDeserializer extends StdDeserializer<Score> {
        ...
        public Score deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            throw new IOException("Failed deserialization for Score: no match found");
        }
        ...
        public Score getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "Score cannot be null");
        }
    }
