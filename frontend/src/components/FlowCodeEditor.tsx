...
import type { FlowEditorSchema, FlowValidationIssue, JsonSchema } from '../api/types'
...
export function buildFlowCompletions(schema?: FlowEditorSchema): {
...
function completionSource(schema?: FlowEditorSchema) {
