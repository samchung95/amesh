...
class RequiredToolStep(BaseModel):
    ...
    for_each: Optional[StrictStr] = Field(default=None, alias="forEach")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RequiredToolStep from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if for_each (nullable) is None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RequiredToolStep from a dict"""
        if obj is None:
            return None
