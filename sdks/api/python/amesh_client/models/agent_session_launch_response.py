...
class AgentSessionLaunchResponse(BaseModel):
    ...
    """ # noqa: E501
    attempt: Optional[Annotated[int, Field(strict=True, ge=1)]] = 1
    execution_id: UUID = Field(alias="executionId")
    execution_state: ExecutionState = Field(alias="executionState")
    session: Optional[AgentSessionSummary] = None
    session_id: UUID = Field(alias="sessionId")
    task_run_id: UUID = Field(alias="taskRunId")
    __properties: ClassVar[List[str]] = ["attempt", "executionId", "executionState", "session", "sessionId", "taskRunId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentSessionLaunchResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentSessionLaunchResponse from a dict"""
        if obj is None:
            return None
