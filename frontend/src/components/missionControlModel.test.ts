...
const details: Record<string, ExecutionDetail> = {
  ...
  failed: { execution: execution('failed', 'FAILED'), taskRuns: [{ task_run_id: 'task-failed', execution_id: 'failed', task_id: 'publish', state: 'FAILED', current_attempt: 2, version: 3, retry_at: null, result: null, iteration_key: null, labels: {}, failure_category: 'HTTP_503', lifecycle_phase: 'MAIN', evidence: {} }], taskRunSummary: { total: 1, waiting: 0, running: 0, retry_delay: 0, succeeded: 0, failed: 1, cancelled: 0 }, taskRunOffset: 0 },
}
