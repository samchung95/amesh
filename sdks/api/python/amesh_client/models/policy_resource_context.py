...
class PolicyResourceContext(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["attributes", "inputs", "task", "taskId", "taskType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PolicyResourceContext from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PolicyResourceContext from a dict"""
        if obj is None:
            return None
