...
class FlowGraph(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["edges", "flowId", "namespace", "nodes", "revision"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nodes": [FlowGraphNode.from_dict(_item) for _item in obj["nodes"]] if obj.get("nodes") is not None else None,
