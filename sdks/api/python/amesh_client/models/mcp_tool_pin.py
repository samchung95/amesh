...
class McpToolPin(BaseModel):
    ...
    impact: Optional[McpToolImpact] = None
    ...
    __properties: ClassVar[List[str]] = ["description", "impact", "inputSchema", "name", "outputSchema"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of McpToolPin from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of McpToolPin from a dict"""
        if obj is None:
            return None
