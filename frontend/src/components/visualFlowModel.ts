...
import type { FlowEditorSchema, FlowResourceSchema } from '../api/types'
...
function taskResources(schema: FlowEditorSchema): Map<string, FlowResourceSchema> {
  return new Map(
...
export function buildVisualFlowGraph(source: string, schema: FlowEditorSchema): VisualFlowGraph {
