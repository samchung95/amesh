...
class EffectiveCapabilityEnvelopeOutput(BaseModel):
    """
    ...
    evaluations: Optional[List[ResolvedAgentEvaluationOutput]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EffectiveCapabilityEnvelopeOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EffectiveCapabilityEnvelopeOutput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "evaluations": [ResolvedAgentEvaluationOutput.from_dict(_item) for _item in obj["evaluations"]] if obj.get("evaluations") is not None else None,
