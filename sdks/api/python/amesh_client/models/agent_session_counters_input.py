...
class AgentSessionCountersInput(BaseModel):
    """
    AgentSessionCountersInput
    """ # noqa: E501
    cost_usd: Optional[Costusd] = Field(default=None, alias="costUsd")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentSessionCountersInput from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of cost_usd
        if self.cost_usd:
            _dict['costUsd'] = self.cost_usd.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentSessionCountersInput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "costUsd": Costusd.from_dict(obj["costUsd"]) if obj.get("costUsd") is not None else None,
