...
class AgentResourceRevisionOutput(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "createdBy", "digest", "key", "kind", "namespace", "resourceId", "revision", "spec", "tenantId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentResourceRevisionOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentResourceRevisionOutput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "spec": Spec1.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
