...
class AgentSessionRecordInput(BaseModel):
    """
    ...
    counters: Optional[AgentSessionCountersInput] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentSessionRecordInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentSessionRecordInput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "counters": AgentSessionCountersInput.from_dict(obj["counters"]) if obj.get("counters") is not None else None,
