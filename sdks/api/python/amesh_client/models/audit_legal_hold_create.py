...
class AuditLegalHoldCreate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["endsAt", "name", "reason", "startsAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AuditLegalHoldCreate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AuditLegalHoldCreate from a dict"""
        if obj is None:
            return None
