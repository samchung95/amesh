...
const (
	EXECUTIONSTATE_CREATED    ExecutionState = "CREATED"
	EXECUTIONSTATE_QUEUED     ExecutionState = "QUEUED"
	EXECUTIONSTATE_RUNNING    ExecutionState = "RUNNING"
	EXECUTIONSTATE_PAUSED     ExecutionState = "PAUSED"
	EXECUTIONSTATE_CANCELLING ExecutionState = "CANCELLING"
	EXECUTIONSTATE_CANCELLED  ExecutionState = "CANCELLED"
	EXECUTIONSTATE_SUCCESS    ExecutionState = "SUCCESS"
	EXECUTIONSTATE_FAILED     ExecutionState = "FAILED"
	EXECUTIONSTATE_WARNING    ExecutionState = "WARNING"
	EXECUTIONSTATE_RESTARTING ExecutionState = "RESTARTING"
)
