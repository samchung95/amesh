...
class AssetObservation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accessMode", "artifactId", "assetId", "confidence", "createdBy", "evidenceKind", "executionId", "flowId", "metadata", "namespace", "observationId", "observedAt", "taskRunId", "tenantId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssetObservation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssetObservation from a dict"""
        if obj is None:
            return None
