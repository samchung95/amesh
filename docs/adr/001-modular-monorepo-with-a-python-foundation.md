...
- **Status:** Accepted / amended by [ADR-016](016-python-production-core.md) on 2026-08-19 — the monorepo decision stands; the "transitional oracle awaiting a Java port" framing is retired and the Python foundation is now the production core seed
