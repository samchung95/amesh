...
describe('buildExecutionTrace', () => {
  it('orders success, conditional, loop, retry and failure evidence as a readable run story', () => {
    ...
    const review = task('review', 'FAILED', { failure_category: 'POLICY_DENIED' })
